...
game.States.boot = function() {
    this.preload = function() {
        ...
        if(!game.device.desktop){
            this.scale.scaleMode = Phaser.ScaleManager.SHOW_ALL//Phaser.ScaleManager.USER_SCALE//Phaser.ScaleManager.RESIZE//Phaser.ScaleManager.NO_SCALE//Phaser.ScaleManager.EXACT_FIT;
